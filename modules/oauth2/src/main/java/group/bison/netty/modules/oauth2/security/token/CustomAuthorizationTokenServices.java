...
public class CustomAuthorizationTokenServices implements AuthorizationServerTokenServices, ConsumerTokenServices {
    ...
    private OAuth2RefreshToken createRefreshToken(OAuth2Authentication authentication) {
        ...
        String value = TokenEncodeTool.getBase64CodeOrTokenWithEnv(UUID.randomUUID().toString());
    ...
    private OAuth2AccessToken createAccessToken(OAuth2Authentication authentication, OAuth2RefreshToken refreshToken) {
        ...
        if (principal instanceof User) {
            ...
            clientId = String.valueOf(principal);
        }

        ClientDetails authClient = clientDetailsService.loadClientByClientId(clientId);
        if (!CollectionUtils.isEmpty(authClient.getAuthorizedGrantTypes()) && authClient.getAuthorizedGrantTypes().contains("iot-service-login")) {
            value = String.valueOf(authentication.getUserAuthentication().getCredentials());
        }
        value = TokenEncodeTool.getBase64CodeOrTokenWithEnv(value);
